...
export type Reaction = {
    ...
    noteId: string;
    /**
     * The reaction. either a UTF8 Emoji, or an emoji string (:edjisigh:).
     */
    reaction: string;
    /**
...
export type MisskeyNote = {
    ...
    channel?: {
        ...
        name: string;
        /**
         * a hexcode color for the channel.
         */
        color: string;
        /**
...
export type File = {
    ...
    id: string;
    /**
     * The Date-Time string of when the file was created or first observed by the homeserver.
     */
    createdAt: string;
    /**
     * the name of the file, as provided by the home/remote server.
     */
    name: string;
    /**
     * the type of the file, by html content-type.
     */
    type: string;
    /**
     * the MD5 generated by the server.
     */
    md5: string;
    /**
     * The size of the file by Bit (NOT BYTE.)
     */
    size: number;
    /**
     * Whether the file is marked as sensitive by the user (or admin)
     */
    isSensitive: boolean;
    /**
     * The blurhash, if the file is image-like.
     */
    blurhash: string;
    /**
     * A list of properties that the file may have - the height and width.
     */
    ...
    url: string;
    /**
     * The compressed thumbnailUrl, if the file is image-like.
     */
    thumbnailUrl: string;
    /**
     * The Alt-text created by the user.
     */
    comment: string;
    /**
     * The ID of the folder that contains the file, if applicable.
     */
    folderId: string | null;
    /**
     * The folder that contains the file, if applicable.
     */
    folder: string | null;
    /**
     * the ID of the user that created the file, if applicable.
     */
    userId: string;
    /**
     * The user that created the file, if applicable.
     */
